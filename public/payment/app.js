...
gatewayForm.addEventListener("submit", async (event) => {
  ...
  gatewayMessage.textContent = "Processing through FoodHub Payment Gateway...";
  ...
  gatewayMessage.textContent = `Payment approved for ${maskedNumber}. Returning to FoodHub...`;
